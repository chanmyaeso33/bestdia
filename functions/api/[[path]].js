...
const trustedPriceThb = (pkg) => Math.round(Number(pkg.supplierPriceThb || 0) * (1 + priceMarginByThb(Number(pkg.supplierPriceThb || 0))));
const withPrice = (pkg, product) => ({
  ...pkg,
  gameKey: product.key,
  gameName: product.name,
  unit: product.unit,
  price: trustedPriceKs(pkg.supplierPriceThb),
